    ...
    const OFFICIAL_SERIES_DATABASE = {
      romans: {
        ...
        'discworld': {
          ...
          status: 'completed',
          keywords: ['discworld', 'disque-monde', 'terry pratchett', 'ankh-morpork', 'rincevent'],
        ...
        'chronicles_narnia': {
          ...
          status: 'completed',
          keywords: ['narnia', 'aslan', 'lion', 'sorcière', 'armoire'],
          variations: ['narnia', 'chronicles of narnia', 'monde de narnia', 'chroniques de narnia'],
          exclusions: ['space trilogy', 'screwtape letters'],
        ...
        'wheel_time': {
          ...
          status: 'completed',
          keywords: ['wheel of time', 'roue du temps', 'rand althor', 'dragon'],
          variations: ['wheel of time', 'roue du temps', 'wot'],
          exclusions: ['new spring', 'companion'],
        ...
        'hitchhiker_guide': {
          ...
          status: 'completed',
          keywords: ['guide voyageur galactique', 'douglas adams', '42', 'arthur dent'],
          variations: ['hitchhiker guide', 'guide voyageur galactique', 'guide du routard galactique'],
          exclusions: ['dirk gently', 'last chance'],
        ...
        'mars_red': {
          ...
          category: 'roman',
          volumes: 3,
          description: 'Trilogie de terraformation de Mars avec colonisation scientifique.',
          first_published: '1992',
          status: 'completed',
          keywords: ['mars red', 'mars rouge', 'terraformation', 'kim stanley robinson'],
          variations: ['mars red', 'mars rouge', 'mars trilogy', 'trilogie mars'],
          exclusions: ['aurora', 'new york'],
          wikipedia_url: 'https://fr.wikipedia.org/wiki/Mars_la_rouge'
        },
        'earthsea': {
          name: 'Terremer',
          ...
          status: 'completed',
          keywords: ['earthsea', 'terremer', 'ged', 'mage', 'ursula le guin'],
          variations: ['earthsea', 'terremer', 'terre mer'],
          exclusions: ['dispossessed', 'left hand'],
        ...
        'expanse': {
          ...
          status: 'completed',
          keywords: ['expanse', 'leviathan wakes', 'holden', 'space opera'],
          variations: ['expanse', 'the expanse', 'l\'expansion'],
          exclusions: ['tv series', 'adaptation'],
        ...
        'kingkiller': {
          ...
          status: 'ongoing',
          keywords: ['kingkiller', 'tueur de roi', 'kvothe', 'patrick rothfuss'],
          variations: ['kingkiller', 'tueur de roi', 'chronique tueur roi'],
        ...
        'mistborn': {
          ...
          exclusions: ['stormlight', 'warbreaker'],
        ...
        'stormlight': {
          ...
          variations: ['stormlight', 'archives roshar', 'archives de roshar'],
          exclusions: ['mistborn', 'warbreaker'],
