  ...
  bd: {
    'dog_man': {
      ...
      volume_titles: {
        ...
        14: 'Dog Man: Big Jim Believes',
      },
      description:
        'Série de bandes dessinées pour enfants de Dav Pilkey (Super Chien au Québec) : un policier mi-homme mi-chien.',
      ...
      exclusions: ['captain underpants', 'capitaine slip', 'cat kid comic club'],
      wikipedia_url: 'https://en.wikipedia.org/wiki/Dog_Man_(comic_book_series)',
      translations: {
        en: 'Dog Man',
        fr: 'Dog Man',
        'fr-ca': 'Super Chien',
